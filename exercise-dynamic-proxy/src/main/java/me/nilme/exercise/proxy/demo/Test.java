package me.nilme.exercise.proxy.demo;
...
public class Test {
    ...
    private static void createProxy() throws Exception
    {
    	...
    	CtClass cc = pool.makeClass("me.nilme.exercise.proxy.demo.StationProxy");
    	
    	//设置接口
    	CtClass interface1 = pool.get("me.nilme.exercise.proxy.demo.TicketService");
    	cc.setInterfaces(new CtClass[]{interface1});
    	
    	//设置Field
    	CtField field = CtField.make("private me.nilme.exercise.proxy.demo.Station station;", cc);
    	
    	cc.addField(field);
    	
    	CtClass stationClass = pool.get("me.nilme.exercise.proxy.demo.Station");
